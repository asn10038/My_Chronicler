...
/**
 * This class handles all the reading from the log stuff as well as something about dispatchers and the clock
 * @author ant
 *
 */
public class ReplayUtils {
	...
	public static int getNextIndex(HashMap replayIndexMap, String[] threadEntries, int fill) {
		...
		//tracks progression of a specific thread along it's progression
