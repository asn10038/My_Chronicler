...
//Serializable portion of the log that contains logs like
// Object, int, byte, float, long etc.
// It also tracts the owners of those objects and the debug issues
// Implementing serializable here lets this class be written to a file
